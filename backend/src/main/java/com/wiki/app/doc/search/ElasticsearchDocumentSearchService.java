...
@Service
@Primary
@ConditionalOnProperty(name = "wiki.search-es-enabled", havingValue = "true")
public class ElasticsearchDocumentSearchService implements IDocumentSearchService {
    private static final Logger log = LoggerFactory.getLogger(ElasticsearchDocumentSearchService.class);
    ...
    public ElasticsearchDocumentSearchService(AppProperties appProperties,
